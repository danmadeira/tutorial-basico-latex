...
Estes comandos do alfabeto grego funcionam somente no modo matemático.
...
\subsection*{Entre parênteses, colchetes e chaves}
\addcontentsline{toc}{subsection}{Entre parênteses, colchetes e chaves}
...
\subsection*{Símbolos diversos}
\addcontentsline{toc}{subsection}{Símbolos diversos}

Estes comandos funcionam somente no modo matemático.
...
$\not\exists$ & \textbackslash not\textbackslash exists &
$\iff$ & \textbackslash iff &
$\equiv$ & \textbackslash equiv &
$\parallel$ & \textbackslash parallel \\
$\not\perp$ & \textbackslash not\textbackslash perp &
...
\subsection*{Text Companion}
\addcontentsline{toc}{subsection}{Text Companion}

Pacote \texttt{\{textcomp\}}.
...
\subsection*{American Mathematical Society}
\addcontentsline{toc}{subsection}{American Mathematical Society}

Pacotes \texttt{\{amsmath\}} e \texttt{\{amssymb\}}.
...
\subsection*{Pi fonts}
\addcontentsline{toc}{subsection}{Pi fonts}

...
Para indicar a quantidade de colunas e o respectivo alinhamento, use a quantidade de letras \texttt{l} (alinhamento à esquerda), \texttt{c} (alinhamento ao centro) e \texttt{r} (alinhamento à direita). No conteúdo, as colunas são delimitadas pelo caractere \texttt{\&}. E ao final de cada linha use uma quebra.

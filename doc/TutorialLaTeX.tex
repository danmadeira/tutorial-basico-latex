...
\usepackage[backend=biber,sorting=none,hyperref=auto,giveninits=false,isbn=false,giveninits]{biblatex} % https://www.ctan.org/pkg/biblatex
...
\begin{wraptable}{r}{6cm}
\begin{center}
\begin{tabular}{|>{\ttfamily\small}c|>{\ttfamily\small}c|>{\ttfamily\small}c|}\hline
    X & O & O \\\hline
      & X & O \\\hline
    O & X & X \\\hline
\end{tabular}
...
\begin{description}
    \item[.tex] Código-fonte do \LaTeX;
    \item[.bib] Referências bibliográficas;
    \item[.ist] Estilo do índice.
\end{description}
\end{multicols}

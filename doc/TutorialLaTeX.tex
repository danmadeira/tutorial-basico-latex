...
\newcommand{\versaomenor}{0}
\newcommand{\versaodecorrecao}{1}
...
Este ambiente pode ser aplicado em linha com o comando \verb|\verb|.\index{verb@\textbackslash verb} Sua sintaxe é \texttt{\textbackslash verb|literalmente um texto|}.\par\;

...
\begin{tabular}{llll}
\textbf{Nome} & \textbf{Pacote} & \textbf{Código} & \textbf{Família}\\
Computer Modern & \texttt{\small{(não precisa,}} & \texttt{\small{cmr}}, & \small{todas famílias}\\
                & \texttt{\small{é o padrão)}}& \texttt{\small{cmss,}} & \\
                & & \texttt{\small{cmtt}} & \\
Latin Modern & \texttt{\small{\{lmodern\}}} & \texttt{\small{lmr}}, & \small{todas famílias}\\
             & & \texttt{\small{lmss,}} & \\
             & & \texttt{\small{lmtt}} & \\
\end{tabular}

\newpage
Fontes comuns Adobe PostScript:
\index{adobe@Adobe}
...
\begin{tabular}{llll}
\textbf{Nome} & \textbf{Pacote} & \textbf{Código} & \textbf{Família}\\
Times & \texttt{\small{\{mathptmx\}}} & \texttt{\small{ptm}} & \small{romano}\\
Palatino & \texttt{\small{\{mathpazo\}}} & \texttt{\small{ppl}} & \small{romano}\\
Helvetica & \texttt{\small{\{helvet\}}} & \texttt{\small{phv}} & \small{sem serifa}\\
Avant Garde & \texttt{\small{\{avant\}}} &  & \small{sem serifa}\\
Courier & \texttt{\small{\{courier\}}} & \texttt{\small{pcr}} & \small{monoespaçado}\\
Zapf Chancery & \texttt{\small{\{chancery\}}} &  & \small{romano}\\
Bookman & \texttt{\small{\{bookman\}}} & \texttt{\small{pbk}} & \small{romano}\\
New Century Schoolbook & \texttt{\small{\{newcent\}}} &  & \small{romano}\\
Charter & \texttt{\small{\{charter\}}} & \texttt{\small{bch}} & \small{romano}\\
Fourier & \texttt{\small{\{fourier\}}} & \texttt{\small{put}} & \small{romano}\\
\end{tabular}
...
\begin{tabular}{llll}
\textbf{Nome} & \textbf{Pacote} & \textbf{Código} & \textbf{Família}\\
Arev & \texttt{\small{\{arev\}}} &  & \small{sem serifa}\\
Bera Serif & \texttt{\small{\{bera\}}} &  & \small{romano}\\
Bera Sans & \texttt{\small{[scaled]\{berasans\}}} &  & \small{sem serifa}\\
Bera Mono & \texttt{\small{[scaled]\{beramono\}}} &  & \small{monoespaçado}\\
\end{tabular}
...
\begin{tabular}{llll}
\textbf{Nome} & \textbf{Pacote} & \textbf{Código} & \textbf{Família}\\
TeX Gyre Adventor & \texttt{\small{\{tgadventor\}}} & \texttt{\small{qag}} & \small{sem serifa}\\
TeX Gyre Bonum & \texttt{\small{\{tgbonum\}}} & \texttt{\small{qbk}} & \small{romano}\\
TeX Gyre Chorus & \texttt{\small{\{tgchorus\}}} & \texttt{\small{qzc}} & \small{romano}\\
TeX Gyre Cursor & \texttt{\small{\{tgcursor\}}} & \texttt{\small{qcr}} & \small{monoespaçado}\\
TeX Gyre Heros & \texttt{\small{\{tgheros\}}} & \texttt{\small{qhv}} & \small{sem serifa}\\
TeX Gyre Pagella & \texttt{\small{\{tgpagella\}}} & \texttt{\small{qpl}} & \small{romano}\\
TeX Gyre Schola & \texttt{\small{\{tgschola\}}} & \texttt{\small{qcs}} & \small{romano}\\
TeX Gyre Termes & \texttt{\small{\{tgtermes\}}} & \texttt{\small{qtm}} & \small{romano}\\
\end{tabular}
...
Como visto, o uso de um pacote de fonte define o tipo da letra por todo o documento. Para selecionar, em um determinado bloco de texto, um tipo de fonte diferente, use os comandos \texttt{\textbackslash fontfamily} para especificar o tipo, \texttt{\textbackslash fontseries} para especificar a série, \texttt{\textbackslash fontshape} para especificar a forma e \texttt{\textbackslash selectfont} para confirmar a seleção. Seguindo esta sintaxe:
...
Use os comandos que desejar e termine com o comando de confirmação. O código é o que está nas tabelas das fontes acima. As séries podem ser, resumidamente, \texttt{m} (médio) e \texttt{b} (negrito). As formas podem ser, resumidamente, \texttt{n} (normal), \texttt{it} (itálico) e \texttt{sl} (inclinado).
...
As diversas séries e formas para os caracteres são:
...
\begin{tabular}{@{}l>{\ttfamily\small}r>{\ttfamily\small}l@{}}
    ...
    \textbf{\textit{Texto em negrito e itálico}} & \textbackslash textbf\{\textbackslash textit\{\}\} & \{\textbackslash mdseries\textbackslash itshape \}\\
...
\begin{center}
\begin{tabular}{>{\ttfamily\small}c|>{\ttfamily\small}c|>{\ttfamily\small}c}
    X & O & O \\\hline
      & X & O \\\hline
    O & X & X \\
\end{tabular}
